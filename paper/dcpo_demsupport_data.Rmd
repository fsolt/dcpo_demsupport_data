...
Researchers expect these advanced methods to extract the "comparable component" of democratic support as a single variable, enabling deeper exploration of its trends, determinants, and consequences [e.g., @Claassen2019; @Solt2020c; @Claassen2020a; @Claassen2022]. 
...
As will be shown later, most surveys gather data on democratic support using Churchill-style questions, which force respondents to place themselves on a scale between complete support and full opposition. 
