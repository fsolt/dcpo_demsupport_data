...
title: |
  | Like Multiple Pegs in One Hole: 
...
bibliography:
  text: [dcpo-demsupport-data.bib, p_dcpo_dem_data.bib]
...
In the U.S., the youth weighted social justice vis-\grave{a}-vis free election differently when considering democracy [@FlanaganEtAl2005].^[In addition to differing priorities, people's expectations of democratic performance can also vary. For a more comprehensive discussion, see @LuChu2022[chpt. 1].]
...
In studies on mass ideology, for example, multidimensional measurements analyze ideological preferences within specific policy areas, such as economic or social issue domains, rather than relying on a one-dimensional left-right scale [@CaugheyWarshaw2016; @Treier2009nature].
...
Previous studies on multidimensional public opinion have shown that individuals or countries may hold liberal views on one dimension (e.g., economic issues) but conservative views on another (e.g., social issues), and a unidimensional measure fails to account for these potential negative correlations between attitudes across different domains [@CaugheyWarshaw2016; @Treier2009nature].
...
The first is a confirmatory method, where separate one-dimensional models are fitted to distinct subsets of items, as illustrated by @CaugheyWarshaw2016 in their study of the multidimensional nature of public ideology.
The second option is an exploratory approach, such as that employed by @Pan2018china, to reveal the underlying dimensions.
A more recent advancement in this field is @BerwickCaughey2024’s article, which utilizes an exploratory group-level Bayesian IRT model to map the dynamic multidimensionality of public opinion within and cross country contexts.
...
See more methodological details in @CaugheyWarshaw2015 and demonstrations in @CaugheyWarshaw2016; @CaugheyWarshaw2018a.]
