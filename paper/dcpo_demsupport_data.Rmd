...
```{r dcpo_input_raw, include=FALSE, cache = TRUE, cache.extra = tools::md5sum(here::here("data-raw", "surveys_ds.csv"))}
surveys_tb <- read_csv(here::here("data-raw", "surveys_ds.csv"),
                       col_types = "cccccc")
