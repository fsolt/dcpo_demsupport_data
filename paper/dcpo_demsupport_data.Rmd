...
In the context of "support for democracy," if people's understanding and prioritization of democracy do not align along a single, unified latent dimension, then any attempt to convert their democratic support into a unidimensional scale is bound to fail.
