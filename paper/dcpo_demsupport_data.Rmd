...
@Tannenberg2022 [, 602] shows that responses to certain indicator questions on democratic support are biased downward in more autocratic countries due to fear of government reprisal, and argues that this bias likely affects the resulting latent variable as well. 
...
Multiple pieces of evidence have suggested that people may weigh different components and aspects of democracy differently [XXX Crow 2010]. 
...
Researchers have found, for instance, that in Europe, people differ in their views on what democracy should prioritize, such as between egalitarian participation and protection of individual rights [XXX Ferrin and Kriesi 2016]. 
In the U.S., the youth weighted social justice vis-\grave{a}-vis free election differently when considering democracy [XXX Flanagan et al. 2005].^[In addition to differing priorities, people's expectations of democratic performance can also vary. For a more comprehensive discussion, see @LuChu2022[chpt. 1].]
...
Moreover, at the individual level, there has been a sustained effort to identify the determinants of democratic support by comparing societies with different socioeconomic and political conditions.^[@LuShi2020 provides a summary of these established efforts and introduces a new approach using global barometer surveys.]
