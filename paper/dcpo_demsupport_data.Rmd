...
Why doesn't this well-developed method yield a stable, consistent, and comparable outcome as expected? 
...
As will be shown later, most surveys gather data on democratic support using Churchill-style questions asking public attitudes in the abstract without considering concrete components in democracy, which force respondents to place themselves on a scale between complete support and full opposition. 
When the meaning of democracy is not consistent, respondents' answers may be based on different cognition or experiences. 
