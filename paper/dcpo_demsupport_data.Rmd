...
Specifically, we note that the latent variable estimates on which it depends themselves depend on the assumption that democratic support falls along a single dimension: that some individuals and some populations support democracy wholeheartedly, others oppose it fully, and everyone else is somewhere between.
