...
It is clear that these data are sparse: if every country that appears in the source data had been surveyed in every year in the source data, we would have at least `r total_cy` observations, and if these hypothetical surveys included every _item_, we would have `r {n_countries * n_years * n_items} %>% scales::comma()` observations.
