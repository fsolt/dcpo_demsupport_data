...
- **Multidimensional alternatives.**
    ...
    In particular, we introduce to readers a new method also based on Bayesian IRT models presented in Berwick and Caughey [-@Berwick2024] that can map the dynamic multidimentions in policy preference and ideology at both individual and country levels.
